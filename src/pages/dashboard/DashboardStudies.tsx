        ...
        <div className="w-full py-4 px-4 lg:py-8 lg:px-6 space-y-6 lg:space-y-8 mt-16 min-h-screen bg-background">
          <div className="space-y-1">
            ...
            <p className="text-sm lg:text-base text-muted-foreground">
              Track and manage your health studies and clinical data
            </p>
          </div>
          ...
          <Card className="border-2 bg-background/80 backdrop-blur-sm">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Health studies management functionality will be available soon. 
                You'll be able to track patient studies, clinical trials, and health data analytics.
              </p>
            </CardContent>
          </Card>
        </div>
